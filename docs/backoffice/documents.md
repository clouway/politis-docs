...
-  Чрез контекстното меню за всяка фактура от списъка с фактури

![Documents](./invoices-list-print.bg.png "Фактури - печат")

-  Чрез контекстното меню от екрана с детайли за фактура

![Documents](./invoices-details-print.bg.png "Фактури - печат")

-  Отпечатване на няколко фактури от списъка с фактури
...
![Клиентски обекти](./mobile-customer-location.bg.png)
  
  
![Клиентски обекти - детайли](./mobile-customer-location-details.png)
...
![Фактури - печат](./mobile-invoices-list-print.bg.png)
  
  
![Детайли за продажби - печат](./mobile-order-details-print.bg.png)
...
-  разваляне на сделка, за която търговеца е издал фактура.
-  поправяне на грешка във вече издадена фактура. Тези грешки възникват при фактуриране на по-голямо количество стоки или услуги от реалните, които са били предоставени на клиента или при фактуране на цени по-високи от договорените, което е задължило клиента да заплати по-висока стойност за доставка.
-  да се направи търговска остъпка като се намали данъчната основа към вече издадена фактура.
...
-  поправяне на грешка във вече издадена фактура. Тези грешки възниква при фактуриране на по-малко количество стоки или услуги от реалните, които са били предоставени на клиента или при фактуриране на цени по-ниски от договорените, което е задължило клиента да заплати по-ниска стойност за доставка.
...
-  Чрез контекстно меню в списъка с доставки. Списъка с доставки е достъпен като от главното меню се избере *Продажби* и след това таб *Доставки*.

![Documents](./shipment-list-print.bg.png "Стокова разписка")

-  Чрез контекстно меню в детайли за доставка, поръчка или фактура.
...
-  Чрез контекстно меню в детайли за поръчка

![Documents](./packing-slip-order-details.bg.png "Списък за опаковане")

-  Чрез контекстно меню в списъка с поръчки
...
![ Списък с трансфери](./mobile-transfers-list.bg.png)
  
  
![Детайли за трансфер - печат](./mobile-transfer-details-print.bg.png)
