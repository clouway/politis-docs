...
![Reports](./purchase-list.png "Заявки за покупка")
    ...
    -  Hово заприхождаване се извършва от бутона в долната част на екрана <i>Заприхождаване</i>.
  
  
![Ново заприхождаване](./add-direct-purchase.png)
...
Основни операции със директно заприхождаване според статуса са следните:
    ...
    <b>ОЧАКВА СТОКА</b>
     <br> -  <b>Детайли</b> - детайли за заприхождаването. Списък с артикули, дата и час на заприхождаване и потребител извършил операцията.
     ...
     <br> -  <b>Завърши</b> - завършва заприхождаването. При тази операция се сменя статуса на  <i>ЗАВЪРШЕНА</i>.
     ...
     <br> -  <b>Получаване</b> - дава възможност за допълване на текущото заприхождаване с още артикули.
  
  
![Статус - ОЧАКВА СТОКА](./purchase-direct-active.bg.png)
...
<br>
    ...
    <b>ЗАВЪРШЕНА</b>
     <br> -  <b>Детайли</b> - детайли за заприхождаването. Списък с артикули, дата и час на заприхождаване и потребител извършил операцията.
     <br> -  <b>Отпечатай заявка</b> - отваря диалогов прозорец с документ <i>Заявка на покупка</i>, който може да бъде отпечатан или запазен във файл.
      <br> -  <b>Протокол за заприхождаване</b> - отваря диалогов прозорец с документ <i>Протокол за заприхождаване</i>, който съдържа списък с всички артикули, които са били заприходени. Протокола може да бъде разпечатан или запазен във файл.
     <br> -  <b>Клонирай</b> - създава нова зявка за покупка с артикулите, участващи в заприхождаването. Създадената заявка е със статус <i>РАБОТЕН ВАРИАНТ</i> и може да бъде редактирана.
     
  
![Статус - ЗАВЪРШЕНА](./purchase-direct-completed.bg.png)
...
![Потвърждение на клониране](./confirm-cloning.png)
