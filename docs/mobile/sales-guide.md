...
На този екран приложението сравнява и текущата позиция на устройството със записаното местоположение на клиентския обект. При съществена разлика предлага да запише текущата позиция като ново местоположение на обекта — виж [Уточняване на координатите](/mobile/routes#уточняване-на-координатите).
