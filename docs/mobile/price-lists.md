...
Подробно описание на работа с номенклатура на клиенти и промяна на ценови листи - [Управление на Клиенти - мобилно приложение](/mobile/relationship-management)
...
За **подробни настройки на ценови листи и ценообразуване** - [Управление на ценови политики - уеб](/backoffice/pricelist-management)

При промяна на ценови листи на клиент от мобилното приложение на Политис трябва да се вземе под внимание **приоритета за прилагане на ценови листи и специални отстъпки към клиенти и клиентски обекти** - [Отправни точки при ценообразуване](/backoffice/pricelist-management#отправни-точки-при-ценообразуване)